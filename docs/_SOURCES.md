...
**Re-verification note (2026-07-24):** the H.R. 1340 cosponsor row below was re-grounded to
the GPO BILLSTATUS XML primary feed and moved 146 -> 147. It moved again to **150 on
2026-08-12** (see the row below). Every other row still carries its
July 18 receipt.
...
| H.R. 1340 (More Homes on the Market Act): **150 cosponsors** (0 withdrawn), referred to Ways & Means Feb 13, 2025; NY cosponsors incl. Malliotakis, Suozzi; **Rep. Gillen not a cosponsor** | [GPO GovInfo BILLSTATUS XML, 119-hr-1340](https://www.govinfo.gov/bulkdata/BILLSTATUS/119/hr/BILLSTATUS-119hr1340.xml) (primary: the official House bill-status feed Congress.gov renders) | **Re-verified 2026-08-12** (was 147 on 2026-07-24, 146 before that). XML fetched 200; parsed 150 `<cosponsors><item>` records, 150 unique bioguideIds, 0 with `sponsorshipWithdrawnDate`; lead sponsor Panetta (P000613) not among them; no `Gillen`. Vintage: GPO file published 2026-08-04 08:39 GMT, latest cosponsorship 2026-08-03 (Ryan, NY-18). Corroborated same-day at [GovTrack](https://www.govtrack.us/congress/bills/119/hr1340), which also reads 150. Congress.gov HTML unreachable to automation (403 to curl and WebFetch; Cloudflare "Just a moment..." challenge to headless Chrome), so the XML feed is the citable primary. **On the "151" some trackers show:** a sponsors-inclusive total runs one higher, because it counts the lead sponsor; 150 is the cosponsor count and is what this project cites. Full receipt: `site/validation.html` row `f-hr1340` |
