...
the GPO BILLSTATUS XML primary feed and moved 146 -> 147. Every other row still carries its
July 18 receipt.
...
| H.R. 1340 (More Homes on the Market Act): **147 cosponsors** (0 withdrawn), referred to Ways & Means Feb 13, 2025; NY cosponsors incl. Malliotakis, Suozzi; **Rep. Gillen not a cosponsor** | [GPO GovInfo BILLSTATUS XML, 119-hr-1340](https://www.govinfo.gov/bulkdata/BILLSTATUS/119/hr/BILLSTATUS-119hr1340.xml) (primary: the official House bill-status feed Congress.gov renders) | **Re-verified 2026-07-24.** XML fetched 200; parsed 147 `<cosponsors><item>` records, 147 unique bioguideIds, 0 with `sponsorshipWithdrawnDate`; lead sponsor Panetta (P000613) not among them; no `Gillen`. Vintage: file `last-modified` 2026-07-21 11:23 GMT, `updateDate` 2026-07-21T08:06:42Z, latest cosponsorship 2026-07-20. Congress.gov HTML unreachable to automation (403 to curl and WebFetch; Cloudflare "Just a moment..." challenge to headless Chrome), so the XML feed is the citable primary. [BillTrack50](https://www.billtrack50.com/billdetail/1833162) shows "Sponsors (148)" = the same 147 cosponsors + lead sponsor; **the trackers do not contradict the primary source**, they label it differently |
