...
The asks are small and local-minded. Two state bills, S3309 and A5288, let a senior who wants to downsize move without losing a tax exemption mid-year. And before the village or district expands the Section 467 senior exemption, whose income limit rises to $75,000 on July 1, 2027, the site asks for a plain parcel-level fiscal note. The rule throughout is that any senior who never moves is left exactly as they are today.

If the Chamber sees value here, I would welcome your support. Reply if you are open to it and I will send a short paragraph you could approve for a "Backed by" note on the site, published only with your written sign-off. I am happy to stop by and walk the board through the one-page deck.

Thank you, and I appreciate all the Chamber does for the village.
