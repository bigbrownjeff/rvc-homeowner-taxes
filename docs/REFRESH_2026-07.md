...
| **S3309/A5288** (benefit continuity in a move year) | Reported from Aging 7-0 (Apr 21, 2026), pending | **Died in Senate Finance at 2026 session close** (no floor vote) | The state ask flips from "pass it this session" to "reintroduce + floor commitment in Jan 2027" |
| **H.R. 1340** | 117+ cosponsors; Gillen absent | **146 cosponsors; Gillen still absent** (NY: Malliotakis, Suozzi on) | Federal ask unchanged and sharper: she's now conspicuous among LI members |
