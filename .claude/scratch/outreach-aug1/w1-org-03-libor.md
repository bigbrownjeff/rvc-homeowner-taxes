...
The state ask most relevant to your members is S3309 and its Assembly companion A5288, which let a senior keep a property tax exemption in the year they sell and move rather than losing it mid-year. S3309 cleared the Senate Aging committee 7 to 0 and then stalled in Finance. It removes a real friction on move-year transactions at almost no cost. The site is careful on one point: any senior who never moves is left exactly as they are today, so this is about widening choice, not pushing anyone.

If this is something LIBOR could support, I would value that. Reply if you are open to it and I will send a short paragraph you could approve for a "Backed by" note on the site, published only with your written sign-off. I would also welcome 15 minutes to walk your Government Affairs Committee through the one-page deck.
