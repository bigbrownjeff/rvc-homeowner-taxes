...
The ask relevant to the Board concerns Section 467, the senior exemption, whose maximum adoptable income limit rises to $75,000 on July 1, 2027. Before the village opts into any expansion, the site asks for a parcel-level fiscal note: how many parcels would qualify by tier, and what each option would shift onto non-exempt taxpayers. The guiding rule is that any senior who never moves should be left exactly as they are today, and that relief should be paired with downsizing options so it does not deepen the housing freeze.

One thing I would ask now: if it would help, I would welcome 15 minutes to walk the Board through the one-page deck. Reply and I will send times that work.
